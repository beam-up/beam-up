  ...
  return (
    <Animated animationIn="fadeIn" animationOut="fadeOut" isVisible={true}>
      <div id="earthText">
        ...
        <p>
          In your travels, you did not encounter another exoplanet that is
          suitable for human life, but don't be discouraged. We have this
          beautiful planet where the existence of life is serendipitous on a
          cosmic scale.
        </p>
        <p>
